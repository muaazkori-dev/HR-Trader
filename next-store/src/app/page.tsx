              ...
              {featuredProducts.map((p) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Image Link */}
                    <Link href={`/product/${p.id}`} className="block relative aspect-square rounded-2xl overflow-hidden bg-white border border-slate-100 mb-4 flex-shrink-0 p-2 flex items-center justify-center">
                      <Image
