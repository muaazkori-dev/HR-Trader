...
copy "C:\Users\Administrator\.gemini\antigravity\brain\1419d0d6-16b6-426a-9bf0-925d8b5f8b89\hr_traders_new_favicon_1781114812720.png" "assets\images\favicon.png" /y
